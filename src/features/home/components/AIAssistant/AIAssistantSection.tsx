			...
			<div className="container-custom relative z-10">
				<div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
					...
					<div>
						...
						>
							Our advanced AI assistant powered by GPT-4 understands your academic needs and provides personalized help
									...
									<div style={{ display: 'flex', gap: '12px' }}>
										...
										>
											<p style={{ margin: 0, marginBottom: '12px' }}>
												<strong>Polymorphism</strong> is one of the fundamental concepts in Object-Oriented Programming (OOP) that allows
												objects to take multiple forms.
											</p>
											<p style={{ margin: 0, marginBottom: '12px' }}>There are two main types:</p>
